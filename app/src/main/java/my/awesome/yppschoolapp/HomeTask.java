...
public class HomeTask extends AppCompatActivity {
    ...
    String DATA_URL = "http://yppschool.com/homeTask.php?class=";
    ...
    HomeTask_Adapter homeTask_adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HomeTask.this.setTitle("Home Work");
        ...
        homeTask_adapter = new HomeTask_Adapter(this,arrayList);
        recyclerView.setAdapter(homeTask_adapter);
            ...
            public void onResponse(String response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(HomeTask.this,error.getMessage().toString(),Toast.LENGTH_LONG).show();
                    }
                });
...
//            vc = collegeData.getString(KEY_VC);
        ...
        recyclerView.setAdapter(homeTask_adapter);
        homeTask_adapter.notifyDataSetChanged();
