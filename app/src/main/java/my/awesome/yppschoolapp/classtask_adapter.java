...
public class classtask_adapter extends RecyclerView.Adapter<classtask_adapter.MyViewHolder> {

    private Context mcontext;
    private List<classtask_class> arrayList;

    public classtask_adapter(Context mcontext, List<classtask_class> arrayList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        view=minflater.inflate(R.layout.list_classtask,parent,false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull classtask_adapter.MyViewHolder holder, int position) {
