...
public class TransportAdapter extends RecyclerView.Adapter<TransportAdapter.MyViewHolder> {
    ...
    public TransportAdapter(Context mcontext, List<FrameClass> arrayList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        view=minflater.inflate(R.layout.item_transport,parent,false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final TransportAdapter.MyViewHolder holder, final int position) {
...
//                        arrayData=arrayListUser.toString().replace("[", "").replace("]", "").trim();
                ...
                Intent intent = new Intent("custom-message-transport");
